	...
	theme: {
		...
		extend: {
			...
			keyframes: {
				...
				'vintage-glow': {
					'0%, 100%': { boxShadow: '0 0 20px hsl(var(--vintage-gold) / 0.2)' },
					'50%': { boxShadow: '0 0 40px hsl(var(--vintage-gold) / 0.4)' }
				}
			},
			backgroundImage: {
